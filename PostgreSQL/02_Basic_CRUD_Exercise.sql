...
-- SELECT
-- 	id, 
-- 	CONCAT_WS(' ', number, street) as addres,
-- 	city_id
...
-- CREATE TABLE IF NOT EXISTS company_chart(full_name) AS
-- SELECT
-- 	CONCAT_WS(' ', first_name, last_name) AS full_name,
-- 	job_title,
-- 	department_id,
...
-- 	e.department_id,
-- 	CONCAT_WS(' ', d.number, d.street) as address 
...
-- Task 22
-- DELETE VIEW IF EXISTS view_employee_addresses_info;
...
-- Task 24
-- Selecting only first 2 chars in column

-- CREATE VIEW view_initials AS
-- SELECT
-- 	substring(first_name from 0 for 3) as initial,
-- 	last_name
-- FROM employees
